...
public class TravelDealListActivity extends AppCompatActivity {
    ...
    private DealViewAdapter dealViewAdapter;
    ...
    protected void onResume() {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                dealViewAdapter = new DealViewAdapter(TravelDealListActivity.this, travelDealList);
                recyclerView.setAdapter(dealViewAdapter);
                dealViewAdapter.notifyDataSetChanged();
            }
